...
**For AI Agents**: See [`.agent/README.md`](.agent/README.md) for instructions on how to interface with this library.
...
- `library/`: The core knowledge base (Skills, Competencies, Tools, Concepts).
- `.agent/`: Instructions and templates for AI Agents.
